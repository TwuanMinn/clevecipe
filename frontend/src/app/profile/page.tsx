...
export default function ProfilePage() {
    ...
    const user = {
        ...
        recipesGenerated: 0, // TODO: Track in store
        favoriteRecipes: favorites.length,
        mealsPlanned: 0, // TODO: Track in store
    };

    // Nutrition stats - uses real data from stores (no fake defaults)
    const weeklyStats = {
        avgCalories: 0, // TODO: Calculate from nutrition log
        targetCalories: dailyCalorieTarget,
        avgProtein: 0, // TODO: Calculate from nutrition log
        mealsLogged: 0, // TODO: Count from nutrition log
    };
            ...
            <div className="relative">
                ...
                >
                    ...
                    >
                        ...
                        >
                            {user.email || "Sign in to see email"}
                        </motion.p>
                        <motion.p
