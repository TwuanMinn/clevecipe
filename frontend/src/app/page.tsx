                    ...
                    demoRecipes.map((recipe) => (
                        ...
                        >
                            <Link href={`/recipe/${recipe.id}`}>
                                <div className="relative flex w-full flex-col gap-4 rounded-xl bg-white dark:bg-[#1a2e1d] p-3 shadow-sm transition-all hover:shadow-md border border-slate-100 dark:border-slate-800/50">
                                    <div className="relative aspect-[4/3] w-full overflow-hidden rounded-xl">
                                        ...
                                        <motion.div
                                            className={`absolute left-3 top-3 flex items-center gap-1 rounded-full px-3 py-1.5 shadow-lg ${recipe.is_primary_match
                                        ...
                                        >
                                            <svg className={`w-4 h-4 ${recipe.is_primary_match ? "text-[#111812]" : "text-[#13ec37]"}`} fill="currentColor" viewBox="0 0 24 24">
                                        ...
                                        {/* Save Button */}
                                        <motion.button
                                            className="absolute right-3 top-3 flex size-10 items-center justify-center rounded-full bg-white/30 backdrop-blur-md text-white transition-colors hover:bg-white hover:text-red-500"
                                    ...
                                    <div className="px-2 pb-2">
                                        <h3 className="text-xl font-bold leading-tight text-[#111812] dark:text-white">
                                            {recipe.title}
                                        </h3>
                                        <div className="mt-3 flex items-center gap-4 text-slate-500 dark:text-slate-400">
                                            <div className="flex items-center gap-1.5">
                                                <svg className="w-5 h-5 text-[#13ec37]" fill="currentColor" viewBox="0 0 24 24">
                                                    <path d="M12 2C6.5 2 2 6.5 2 12s4.5 10 10 10 10-4.5 10-10S17.5 2 12 2zm4.2 14.2L11 13V7h1.5v5.2l4.5 2.7-.8 1.3z" />
                                                </svg>
                                                <span className="text-sm font-semibold">{recipe.prep_time} min</span>
                                            </div>
